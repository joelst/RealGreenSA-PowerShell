...
$Manifest = @{
    ...
    Description = 'RealGreenSAPS - the PowerShell module for RGS Common API'

    ModuleVersion = '0.1.2'

    RootModule = 'RealGreenSAPS.psm1'
    Guid = '{14169448-989D-4673-9C2E-C34C05E7C614}' # Has to be static, otherwise each new build will be considered different module
