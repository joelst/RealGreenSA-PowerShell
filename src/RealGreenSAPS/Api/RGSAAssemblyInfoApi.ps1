...
AssemblyInfo
#>
function Invoke-RGSAAssemblyInfoGetAssemblyInfoGet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-RGSAAssemblyInfoGetAssemblyInfoGet' | Write-Debug
        ...
        $LocalVarUri = '/AssemblyInfo/GetAssemblyInfo'

        if (!$ApiKey) {
            throw "Error! The required parameter `ApiKey` missing when calling assemblyInfoGetAssemblyInfoGet."
        }
