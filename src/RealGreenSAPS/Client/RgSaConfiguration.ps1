...
Get the configuration object 'RGSAConfiguration'.
...
#>
function Get-RGSAConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://saapi.realgreen.com";
    }
...
System.Collections.Hashtable
#>
function Set-RGSAConfiguration {
...
None
#>
function Set-RGSAConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-RGSAConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-RGSAConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
System.Collections.Hashtable[]
#>
function Get-RGSAHostSetting {
    return ,@(
          @{
            "Url" = "https://saapi.realgreen.com";
...
String
#>
function Get-RGSAUrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-RGSAConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-RGSAKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'RGSAConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-RGSAConfigurationHttpSigning{
