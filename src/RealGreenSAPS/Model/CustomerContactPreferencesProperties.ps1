...
CustomerContactPreferencesProperties<PSCustomObject>
#>

function Initialize-RgSaCustomerContactPreferencesProperties {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: RealGreenSAPS => RgSaCustomerContactPreferencesProperties' | Write-Debug
...
Convert from JSON to CustomerContactPreferencesProperties<PSCustomObject>
...
CustomerContactPreferencesProperties<PSCustomObject>
#>
function ConvertFrom-RgSaJsonToCustomerContactPreferencesProperties {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: RealGreenSAPS => RgSaCustomerContactPreferencesProperties' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RgSaCustomerContactPreferencesProperties
        $AllProperties = ("dontTelemarket", "dontDirectMail", "dontEmail", "emailStatements", "emailPrenotification", "dontTelemarketLocal", "dontTelemarketCustomerRequest", "dontUpsell", "preferredPhone", "autoPay", "contactPreferred", "noKnock", "cawRegisteredUser", "preferredLanguage", "textPrenotification", "dontFollowupByEmail", "dontText", "dontEmailInvoice", "amaAdministrative", "amaMarket", "amaService")
