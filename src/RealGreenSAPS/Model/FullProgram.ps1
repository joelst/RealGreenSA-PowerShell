...
FullProgram<PSCustomObject>
#>

function Initialize-RgSaFullProgram {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: RealGreenSAPS => RgSaFullProgram' | Write-Debug
...
Convert from JSON to FullProgram<PSCustomObject>
...
FullProgram<PSCustomObject>
#>
function ConvertFrom-RgSaJsonToFullProgram {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
