...
SeasonSummaryByRoundCycleResult<PSCustomObject>
#>

function Initialize-RgSaSeasonSummaryByRoundCycleResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: RealGreenSAPS => RgSaSeasonSummaryByRoundCycleResult' | Write-Debug
...
Convert from JSON to SeasonSummaryByRoundCycleResult<PSCustomObject>
...
SeasonSummaryByRoundCycleResult<PSCustomObject>
#>
function ConvertFrom-RgSaJsonToSeasonSummaryByRoundCycleResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: RealGreenSAPS => RgSaSeasonSummaryByRoundCycleResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RgSaSeasonSummaryByRoundCycleResult
