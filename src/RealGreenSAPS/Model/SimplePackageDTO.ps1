...
SimplePackageDTO<PSCustomObject>
#>

function Initialize-RgSaSimplePackageDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: RealGreenSAPS => RgSaSimplePackageDTO' | Write-Debug
...
Convert from JSON to SimplePackageDTO<PSCustomObject>
...
SimplePackageDTO<PSCustomObject>
#>
function ConvertFrom-RgSaJsonToSimplePackageDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: RealGreenSAPS => RgSaSimplePackageDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RgSaSimplePackageDTO
        $AllProperties = ("cust_no", "size", "route", "status", "soldby1", "reqtakenby", "billtype", "disccode", "autorenew", "technote", "custnote", "season", "sourcecd", "rejcode", "callahead", "datesold", "auditEmployeeID", "packageID")
